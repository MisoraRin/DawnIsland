...
/** 
 * DAO for table "SERIES_DAO".
*/
public class SeriesDAODao extends AbstractDao<SeriesDAO, Void> {

    public static final String TABLENAME = "SERIES_DAO";

    /**
     * Properties of entity SeriesDAO.<br/>
    ...
    public static class Properties {
        ...
        public final static Property Sage = new Property(15, boolean.class, "sage", false, "SAGE");
        public final static Property Admin = new Property(16, boolean.class, "admin", false, "ADMIN");
    ...
    public SeriesDAODao(DaoConfig config) {
        super(config);
    }
    
    public SeriesDAODao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"SERIES_DAO\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"SERIES_DAO\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, SeriesDAO entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, SeriesDAO entity) {
        stmt.clearBindings();
        stmt.bindString(1, poConverter.convertToDatabaseValue(entity.getPo()));
        stmt.bindLong(2, entity.getLastPage());
        stmt.bindLong(3, entity.getLastReplyCount());
    ...
    @Override
    public SeriesDAO readEntity(Cursor cursor, int offset) {
        SeriesDAO entity = new SeriesDAO( //
            ...
            cursor.getShort(offset + 15) != 0, // sage
            cursor.getShort(offset + 16) != 0, // admin
    ...
    @Override
    public void readEntity(Cursor cursor, SeriesDAO entity, int offset) {
        ...
        entity.setSage(cursor.getShort(offset + 15) != 0);
        entity.setAdmin(cursor.getShort(offset + 16) != 0);
        entity.setReplyCount(cursor.getInt(offset + 17));
     }
    
    @Override
    protected final Void updateKeyAfterInsert(SeriesDAO entity, long rowId) {
        // Unsupported or missing PK type
        return null;
    }
    
    @Override
    public Void getKey(SeriesDAO entity) {
        return null;
    }

    @Override
    public boolean hasKey(SeriesDAO entity) {
        // TODO
        return false;
    }
